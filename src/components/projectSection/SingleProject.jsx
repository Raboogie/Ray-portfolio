...
const SingleProject = ({ image, name, year, align, link }) => {
	return (
		...
		>
			<div>
				<h2 className="md:text-3xl sm:text-2xl text-amber-400">
					{name}
				</h2>
				<h2
				...
				<a
					href={link}
					className={`text-lg flex gap-2 items-center text-cyan-400 hover:text-amber-400 transition-all duration-500 cursor-pointer sm:justify-center ${
